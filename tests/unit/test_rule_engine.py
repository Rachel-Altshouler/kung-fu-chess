...
class TestRuleEngine(unittest.TestCase):
    ...
    def test_can_capture_enemy_king(self):
        self.board.set_grid([
            ['wR', '.', 'bK'],
            ['.', '.', '.'],
            ['.', '.', '.']
    ...
    def test_white_pawn_forward_move(self):
        ...
        self.assertTrue(RuleEngine.is_valid_move(self.board, (1, 1), (0, 1)))
    ...
    def test_black_pawn_forward_move(self):
        ...
        self.assertTrue(RuleEngine.is_valid_move(self.board, (0, 1), (1, 1)))
    ...
    def test_pawn_diagonal_capture(self):
        ...
        self.assertTrue(RuleEngine.is_valid_move(self.board, (1, 1), (0, 2)))
    ...
    def test_pawn_cannot_capture_forward(self):
        ...
        self.assertFalse(RuleEngine.is_valid_move(self.board, (1, 1), (0, 1)))

    def test_valid_move_with_position_object(self):
        from domain.position import Position
        self.assertTrue(RuleEngine.is_valid_move(self.board, Position(0, 0), Position(1, 1)))
