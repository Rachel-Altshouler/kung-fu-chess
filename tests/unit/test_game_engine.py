...
class TestGameEngine(unittest.TestCase):
    ...
    def test_capture_king_ends_game(self):
        ...
        self.assertTrue(self.engine.try_move((0, 0), (0, 2)))
        self.engine.handle_wait(200)
    ...
    def test_check_threat_does_not_end_game_in_engine(self):
        self.board.set_grid([
            ['wR', '.', 'bK'],
            ['.', '.', '.'],
            ['wK', '.', '.']
    ...
    def test_checkmate_position_does_not_end_game(self):
        ...
        self.engine.handle_wait(0)
        self.assertFalse(self.engine.is_game_over())
        self.assertTrue(self.engine.try_move((0, 1), (0, 2)))
    ...
    def test_late_move_commands_ignored_after_game_over(self):
        ...
        self.assertFalse(self.engine.try_move((0, 2), (0, 1)))
    ...
    def test_knight_jump_can_capture_king(self):
        self.board.set_grid([
            ['bK', 'wR', '.'],
            ['.', '.', '.'],
            ['.', '.', 'wK'],
        ])
        self.assertTrue(self.engine.try_move((0, 1), (0, 0)))
        self.engine.handle_wait(200)
        self.assertTrue(self.engine.is_game_over())
        self.assertEqual(self.engine.get_winner(), 'w')
